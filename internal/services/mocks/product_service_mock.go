...
func (m *ProductServiceMock) GetAllProducts(page uint, limit uint, minPrice int64, maxPrice int64, searchName string, categoryIDs []int,sizeIDs []string) ([]models.Product, int64, error)  {
